...
public class BasicTempTrainer {
    ...
    public void predict(BasicNetwork network) {
        ...
        System.out.println("Time\tActual\tPredict\tClosed Loop Predict");
    ...
    public static void main(String[] args) {
        BasicTempTrainer basicTempTrainer = new BasicTempTrainer();
        basicTempTrainer.run();
