...
public class SVMBatteryTrainer {
    ...
    public void normalizeBatteryWithTimeBetween(double lo, double hi, Timestamp start, Timestamp stop) {
        bws = DAOManager.getDataWithTimeBetween(DataSourceFactory.getDataSource(), BATTERY_ID, start, stop);
    ...
    public static void main(String[] args) {
        SVMBatteryTrainer SVMBatteryTrainer = new SVMBatteryTrainer();
        SVMBatteryTrainer.run();
